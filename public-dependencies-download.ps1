...
$urls = @(
    "https://github.com/atlas-rust-servers/console-extension/releases/latest/download/Oxide.Ext.ConsoleExt.dll",
    "https://github.com/atlas-rust-servers/gizmos-extension/releases/latest/download/Oxide.Ext.GizmosExt.dll",
    "https://github.com/atlas-rust-servers/triggers-extension/releases/latest/download/Oxide.Ext.TriggersExt.dll",
    "https://github.com/atlas-rust-servers/discord-extension/releases/latest/download/Oxide.Ext.DiscordExt.dll",
    "https://github.com/atlas-rust-servers/ilovepatatos-extension/releases/latest/download/Oxide.Ext.IlovepatatosExt.dll",
    "https://github.com/atlas-rust-servers/battlemetrics-framework/releases/latest/download/Oxide.Ext.BattleMetricsFramework.dll",
